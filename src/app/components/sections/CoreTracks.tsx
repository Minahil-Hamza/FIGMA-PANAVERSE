    ...
    return (
        <section className="mt-16 lg:mt-20 overflow-hidden">
            <div className="absolute left-0 hidden sm:block">
                <div className="blur-[150px] -z-20 bg-[#05c19cb3] w-64 rounded-full"></div>
            </div>
            <Wrapper>
                {/* content */}
                ...
                {/*boxes*/}
                <div className="flex flex-col justify-center md:flex-row gap-y-4 items-stretch my-20 gap-x-4 max-w-screen-xl m-x-auto">
